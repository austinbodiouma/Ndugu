...
fun DisputeRoot(
    onNavigateBack: () -> Unit,
    viewModel: DisputeViewModel = koinViewModel(),
) {
    val state by viewModel.state.collectAsStateWithLifecycle()

    ObserveAsEvents(viewModel.events) { event ->
        when (event) {
            is DisputeEvent.NavigateBack -> onNavigateBack()
        }
    }
        ...
        Scaffold(
            topBar = {
                TopAppBar(
                    ...
                    navigationIcon = {
                        IconButton(onClick = { onAction(DisputeAction.OnBackClick) }) {
                            Icon(
            ...
            Box(
                ...
                if (state.isLoading) {
                    ...
                    Column(
                        ...
                        Text(
                            text = "Dispute Transaction Screen Content",
