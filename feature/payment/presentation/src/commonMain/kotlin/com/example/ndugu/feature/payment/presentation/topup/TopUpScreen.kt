...
fun TopUpRoot(
    ...
    ObserveAsEvents(viewModel.events) { event ->
        when (event) {
            is TopUpEvent.NavigateBack -> onNavigateBack()
        }
    }
        ...
        Scaffold(
            topBar = {
                TopAppBar(
                    ...
                    navigationIcon = {
                        IconButton(onClick = { onAction(TopUpAction.OnBackClick) }) {
                            Icon(
            ...
            Box(
                ...
                if (state.isLoading) {
                    ...
                    Column(
                        ...
                        Text(
                            text = "Top Up Wallet Screen Content",
